...
- [2026-05-31-pluggable-streaming-engines.md](2026-05-31-pluggable-streaming-engines.md) — Re-admit whisper-stream as an opt-in experimental engine behind a schema-driven settings substrate; ffmpeg + whisper-server stays the default.

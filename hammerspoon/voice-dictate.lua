--- @fileoverview Hotkey-driven local dictation: PTT + toggle, whisper-stream backend.
---
...
--- toggle_mods, toggle_key, right_alt_keycode, stream_sh, stream_append_only,
--- and the optional hide_hammerspoon_icon.
